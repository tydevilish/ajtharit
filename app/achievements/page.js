...
export default function Achievements() {
  ...
  // ผลงานทั้งหมดในรูปแบบเดียว
  const allAchievements = [
    { id: 1, image: "/achievements/1.png" },
    { id: 2, image: "/achievements/2.png" },
    { id: 3, image: "/achievements/3.png" },
    { id: 4, image: "/achievements/4.jpg" },
    { id: 5, image: "/achievements/5.jpg" },
    { id: 6, image: "/achievements/6.jpg" },
    { id: 7, image: "/achievements/7.jpg" },
    { id: 8, image: "/achievements/8.jpg" },
    { id: 9, image: "/achievements/9.jpg" },
    ...
    { id: 22, image: "/achievements/22.jpg" },
    { id: 23, image: "/achievements/23.jpg" },
    { id: 24, image: "/achievements/24.jpg" },
    { id: 25, image: "/achievements/25.jpg" },
    { id: 26, image: "/achievements/26.jpg" },
    { id: 27, image: "/achievements/27.jpg" },
    { id: 28, image: "/achievements/28.jpg" },
    { id: 29, image: "/achievements/29.jpg" },
    { id: 30, image: "/achievements/30.jpg" },
    { id: 31, image: "/achievements/31.jpg" }
  ];
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-lime-50 mt-20">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Tech symbols */}
        <Heart className="absolute top-[20%] right-[8%] w-8 h-8 text-emerald-500/20 animate-pulse" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500/10 to-lime-500/10 border border-emerald-300/30 rounded-full backdrop-blur-sm mb-6 hover:shadow-lg hover:scale-105 transition-all">
            ...
            <span className="text-emerald-600 text-sm font-semibold">Achievements</span>
          </div>
          ...
          <p className="text-lg text-slate-600 max-w-4xl mx-auto leading-relaxed">
            ความภาคภูมิใจและความสำเร็จในการทำงานด้านการศึกษา วิจัย และนวัตกรรม
          </p>
        </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {allAchievements.map((achievement, index) => (
              ...
              >
                {/* Achievement Image */}
                <div className="relative overflow-hidden cursor-pointer" onClick={() => setSelectedImage(achievement)}>
                  <div 
