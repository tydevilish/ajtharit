...
export default function Services() {
  ...
  // บริการวิชาการทั้งหมดในรูปแบบเดียว
  const allServices = [
    { id: 1, image: "/services/1.jpg" },
    { id: 2, image: "/services/2.png" },
    { id: 3, image: "/services/3.jpg" },
    { id: 4, image: "/services/4.jpg" },
    { id: 5, image: "/services/5.jpg" },
    { id: 6, image: "/services/6.jpg" },
    { id: 7, image: "/services/7.png" },
    { id: 8, image: "/services/8.jpg" },
    { id: 9, image: "/services/9.jpg" },
    { id: 10, image: "/services/10.jpg" },
    { id: 11, image: "/services/11.jpg" },
    { id: 12, image: "/services/12.jpg" },
    { id: 13, image: "/services/13.jpg" },
    { id: 14, image: "/services/14.jpg" },
    { id: 15, image: "/services/15.jpg" },
    { id: 16, image: "/services/16.jpg" },
    { id: 17, image: "/services/17.jpg" },
    { id: 18, image: "/services/18.jpg" },
    { id: 19, image: "/services/19.jpg" },
    { id: 20, image: "/services/20.jpg" }
  ];
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-lime-50 mt-20">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Academic symbols */}
        <Users className="absolute top-[20%] right-[8%] w-8 h-8 text-emerald-500/20 animate-pulse" />
        <BookOpen className="absolute top-[55%] left-[5%] w-6 h-6 text-lime-500/20 animate-pulse-delayed" />
        <Award className="absolute bottom-[35%] right-[20%] w-10 h-10 text-emerald-500/15 animate-pulse-slow" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500/10 to-lime-500/10 border border-emerald-300/30 rounded-full backdrop-blur-sm mb-6 hover:shadow-lg hover:scale-105 transition-all">
            ...
            <span className="text-emerald-600 text-sm font-semibold">Academic Services</span>
          </div>
          ...
          <p className="text-lg text-slate-600 max-w-4xl mx-auto leading-relaxed">
            การให้บริการวิชาการแก่สังคม การเป็นวิทยากร คณะกรรมการ และการมีส่วนร่วมในกิจกรรมทางวิชาการต่าง ๆ
          </p>
        </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {allServices.map((service, index) => (
              ...
              >
                {/* Service Image */}
                <div className="relative overflow-hidden cursor-pointer" onClick={() => setSelectedImage(service)}>
                  <div 
            ...
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
              ...
              <div className="p-6 border-b border-slate-200 bg-gradient-to-r from-emerald-50 to-lime-50">
                <div className="flex items-center justify-between">
                  <h3 className="text-2xl font-bold text-slate-800">Academic Service</h3>
                  <button
                    onClick={() => setSelectedImage(null)}
